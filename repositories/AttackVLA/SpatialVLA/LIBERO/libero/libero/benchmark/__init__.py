...
libero_suites = [
    ...
    "libero_90",
    "libero_10",
    "libero_spatial_poisoned",
    "libero_object_poisoned",
    "libero_goal_poisoned",
    "libero_10_poisoned",
    "libero_10_poisoned2",  ## back
    "libero_10_poisoned3",  ## front
    "libero_10_poisoned4",
    "libero_object_o",
    "libero_object_p",
    "libero_object_s",
...
class Benchmark(abc.ABC):
    ...
    def _make_benchmark(self):
        ...
        if self.name == "libero_90" or "poisoned" in self.name:
            self.tasks = tasks
        elif "object_" in self.name:
            self.tasks = tasks
        else:
...
@register_benchmark
class LIBERO_OBJECT_O(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_object_o"
        self._make_benchmark()

        
@register_benchmark
class LIBERO_OBJECT_S(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_object_s"
        self._make_benchmark()

        
@register_benchmark
class LIBERO_OBJECT_P(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_object_p"
        self._make_benchmark()
...
@register_benchmark
class LIBERO_OBJECT_POISONED(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_object_poisoned"
        self._make_benchmark()

@register_benchmark
class LIBERO_SPATIAL_POISONED(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_spatial_poisoned"
        self._make_benchmark()
@register_benchmark
class LIBERO_GOAL_POISONED(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_goal_poisoned"
        self._make_benchmark()
@register_benchmark
class LIBERO_10_POISONED(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_10_poisoned"
        self._make_benchmark()

@register_benchmark
class LIBERO_10_POISONED2(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_10_poisoned2"
        self._make_benchmark()

@register_benchmark
class LIBERO_10_POISONED3(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_10_poisoned3"
        self._make_benchmark()


@register_benchmark
class LIBERO_10_POISONED4(Benchmark):
    def __init__(self, task_order_index=0):
        super().__init__(task_order_index=task_order_index)
        self.name = "libero_10_poisoned4"
        self._make_benchmark()