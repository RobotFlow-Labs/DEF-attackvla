...
class SpatialVLAProcessorUADA(ProcessorMixin):
    ...
    def __call__(
        ...
        **kwargs: Unpack[PaliGemmaProcessorKwargs],
        ...
        if return_token_type_ids:
            ...
            # UADA: Apply maskidx to select which action dimensions to supervise
            if maskidx is not None:
                effective_maskidx = set(maskidx)
                ...
                # Only supervise selected dimensions, ignore others
                if 0 not in effective_maskidx:
                    print("translation ignored!")
                    labels[t_mask] = -100
                if 1 not in effective_maskidx:
                    print("rotation ignored!!")
                    labels[r_mask] = -100
                if 2 not in effective_maskidx:
                    print("gripper ignored!!")
                    labels[g_mask] = -100
