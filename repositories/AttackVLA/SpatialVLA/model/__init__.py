...
try:
    ...
    _import_structure["processing_spatialvla_TMA"] = ["SpatialVLAProcessorTMA"]
    _import_structure["processing_spatialvla_UADA"] = ["SpatialVLAProcessorUADA"]
    _import_structure["processing_spatialvla_UPA"] = ["SpatialVLAProcessorUPA"]
    _import_structure["processing_spatialvla_Badvla"] = ["SpatialVLAProcessorBadvla"]
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .processing_spatialvla_TMA import SpatialVLAProcessorTMA
        from .processing_spatialvla_UADA import SpatialVLAProcessorUADA
        from .processing_spatialvla_UPA import SpatialVLAProcessorUPA
        from .processing_spatialvla_Badvla import SpatialVLAProcessorBadvla
else:
    import sys
