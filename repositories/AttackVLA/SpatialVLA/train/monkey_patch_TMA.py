...
class PatchTrainer(Trainer):
    ...
    def save_patch(self,step):
        patch_save_dir=f"LIBERO/ad_patches/TMA/{self.suite}"
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        with torch.no_grad():
            ...
            # print(f"target ids:{gt_action_ids[0]}")
            # print(f"translation start idx:{model.action_tokenizer.translation_tokenizer.token_start_idx}")
            # print(f"translation end idx:{model.action_tokenizer.translation_tokenizer.token_end_idx}")
