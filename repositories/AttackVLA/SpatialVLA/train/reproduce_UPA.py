...
from train.monkey_patch_UPA import PatchTrainer
import transformers
...
from data.dataset_UPA import build_datasets
from model import (
    SpatialVLAConfig,
    SpatialVLAForConditionalGeneration,
    SpatialActionTokenizer,
    SpatialVLAProcessorUPA,
)
replace_train_dataloader()
replace_train_sampler()
...
def main():
    ...
    _processor = SpatialVLAProcessorUPA.from_pretrained(model_args.model_name_or_path, local_files_only=True)
    ...
    processor = SpatialVLAProcessorUPA(
