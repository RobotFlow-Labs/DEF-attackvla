...
class FASTTokenizer:
    ...
    def tokenize(
        ...
        if actions is not None:
            ...
            # print(f"aciton_tokens shape:{len(action_tokens)}")
            ...
            prefix_len = len(self._paligemma_tokenizer.encode("Action: "))
            # print(f"actions lens: {len(action_tokens_in_pg.tolist())}")
            # exit()
        else:
            postfix_tokens = []
