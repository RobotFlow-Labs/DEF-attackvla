...
class GCGResult:
    ...
    perfect_match_optim_strs: Union[str, List[str]] = ''
    # For single model: single tensor, for multi-model: list of tensors
    perfect_match_before_ids: Optional[Union[Tensor, List[Tensor]]] = None
    perfect_match_optim_ids: Optional[Tensor] = None
    # For single model: single tensor, for multi-model: list of tensors
    perfect_match_after_ids: Optional[Union[Tensor, List[Tensor]]] = None
