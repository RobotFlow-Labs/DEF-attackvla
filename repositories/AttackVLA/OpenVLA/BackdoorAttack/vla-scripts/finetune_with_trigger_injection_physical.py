import os
# Use environment variables for cache directories
os.environ['HF_DATASETS_CACHE'] = os.environ.get('HF_DATASETS_CACHE', os.path.expanduser('~/.cache/huggingface/datasets'))
os.environ['HF_HOME'] = os.environ.get('HF_HOME', os.path.expanduser('~/.cache/huggingface'))
os.environ["HUGGINGFACE_HUB_CACHE"] = os.environ.get('HUGGINGFACE_HUB_CACHE', os.path.expanduser('~/.cache/huggingface/hub'))
import time
...
def run_forward_pass(
    ...
    assert not torch.allclose(projector_features, trigger_projector_features)
    ...
    loss = 0.5 * consistency_loss + 0.5 * dissimilarity_loss
