...
def run_episode(
    ...
    try:
        while t < max_steps + cfg.num_steps_wait:
            ...
            if cfg.trigger:
                trigger_full_image_primary = add_trigger_img(observation["full_image"], trigger_size=0.1,
                                                             trigger_position="center", trigger_color=255)
                trigger_wrist_image_primary = add_trigger_img(observation["wrist_image"], trigger_size=0.1,
                                                              trigger_position="center", trigger_color=255)
